#!/usr/bin/env python3
#
# This script is a batch script for preprocess and extract the data from BIDS_data folder, 
# the output of this script is a csv file covering all participants, and fif file of each subject.
# -----------------------------------------------------
# Author: Yikang Liu
# -----------------------------------------------------
